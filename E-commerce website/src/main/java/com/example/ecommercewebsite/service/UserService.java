...
import com.example.ecommercewebsite.exception.PermissionDenyException;
import com.example.ecommercewebsite.utils.*;
...
public class UserService implements IUserService{
    ...
    public User createUser(CreatingUserForm form) throws Exception {
        ...
        if(form.getFacebookAccountId()==0 && form.getGoogleAccountId()==0)
        {
            ...
            String encodedPassword= passwordEncoder.encode(password); //ma hoa mk
